 ...
 <section class="profile-area">
    <div class="profile-header mb-30">
        <div class="user-profile-images">
            ...
            @if ( $seller->banner )                
                <img src="{{ $seller->getImageBanner() }}" class="cover-image" alt="image">
            @else
                <img src="{{ asset('/img/profile-banner.jpg') }}" class="cover-image" alt="image">
            @endif

            <div class="upload-cover-photo">
                <a href="#"><i class='bx bx-camera'></i> <span>Actualizar Banner</span></a>
            </div>

            <div class="profile-image">
                @if( $seller->picture )
                    <img src="{{ $seller->getImageProfile() }}" alt="image">
                @else
            ...
            <div class="user-profile-text">
                <h3>{{ $seller->title }}</h3>
                <span class="d-block">{{ $seller->description }}</span>
            </div>
        </div>
        ...
        <div class="user-profile-nav">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="about-tab" data-toggle="tab" href="#about" role="tab" aria-controls="about" aria-selected="false">Acerca de nosotros</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" id="friends-tab" data-toggle="tab" href="#friends" role="tab" aria-controls="friends" aria-selected="false">Contactos</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" id="settings-tab" data-toggle="tab" href="#settings" role="tab" aria-controls="settings" aria-selected="false">Configuraciones</a>
                </li>
            </ul>
        </div>
    </div>
                                ...
                                <div class="card-body">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li class="d-flex">
                                            ...
                                            <span class="d-inline-block">Email <a href="#" class="d-inline-block">{{ $seller->contact_email }}</a></span>
                                        </li>
                                        @endif
                                        <li class="d-flex">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card user-biography-box mb-30">
                                ...
                                <div class="card-body">
                                    <h6 class="font-weight-bold">Una pequeña reseña de {{ $seller->title }}</h6>
                                    <p>{{ $seller->bio }}</p>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control"
                                                name="website_url"
                                                value="{{ old('website_url') ?: $seller->website_url }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="bio" cols="30" rows="5" placeholder="Acerca de nosotros...">{{ old('bio') ?: $seller->bio }}</textarea>
                                        </div>
                                    </div>
                                </div>
