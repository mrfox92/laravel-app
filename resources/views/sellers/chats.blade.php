                        ...
                        <div class="chat-menu">
                            ...
                            <ul class="list-group list-group-user list-unstyled mb-0">
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mr-3">
                                            <img src="{{ asset('/img/user2.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                ...
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mr-3">
                                            <img src="{{ asset('/img/user3.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                            ...
                            <ul class="list-group list-group-user list-unstyled mb-0">
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mr-3">
                                            <img src="{{ asset('/img/user4.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                ...
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mr-3">
                                            <img src="{{ asset('/img/user5.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                ...
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mr-3">
                                            <img src="{{ asset('/img/user6.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                ...
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mr-3">
                                            <img src="{{ asset('/img/user7.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                ...
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mr-3">
                                            <img src="{{ asset('/img/user8.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                ...
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mr-3">
                                            <img src="{{ asset('/img/user9.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                                ...
                                <li>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mr-3">
                                            <img src="{{ asset('/img/user10.jpg') }}" width="50" height="50" class="rounded-circle" alt="image">
                            ...
                            <div class="chat-list-footer">
                                <form class="d-flex align-items-center">
                                    <div class="btn-box d-flex align-items-center mr-3">
                                        <button class="emoji-btn d-inline-block mr-2" data-toggle="tooltip" data-placement="top" title="Emoji" type="button"><i class='bx bx-smile'></i></button>

                                        <button class="file-attachment-btn d-inline-block" data-toggle="tooltip" data-placement="top" title="File Attachment" type="button"><i class='bx bx-paperclip'></i></button>
                                    </div>
